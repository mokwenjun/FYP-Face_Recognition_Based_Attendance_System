...
{
   /// <summary>
   /// A face recognizer using PCA (Principle Components Analysis)
   /// </summary>
   [Serializable]
   public class EigenFaceRecognizer
   {
      ...
      public EigenFaceRecognizer(Image<Gray, Byte>[] images, ref MCvTermCriteria termCrit)
      ...
      /// <param name="termCrit">The criteria for recognizer training</param>
      public EigenFaceRecognizer(Image<Gray, Byte>[] images, String[] labels, ref MCvTermCriteria termCrit)
      ...
      /// </param>
      /// <param name="termCrit">The criteria for recognizer training</param>
      public EigenFaceRecognizer(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit)
      {
